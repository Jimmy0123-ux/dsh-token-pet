...
const secondaryButton: import('react').CSSProperties = { minWidth: 0, overflowWrap: 'anywhere', flex: '1 1 100px', color: 'var(--tp-text) !important', background: 'var(--tp-accent-soft)', border: '1px solid var(--tp-border-strong)', borderRadius: 7, padding: '5px 8px', cursor: 'pointer', fontSize: 11 }
const dangerButton: import('react').CSSProperties = { ...secondaryButton, color: 'var(--tp-danger-2) !important', background: 'var(--tp-danger-bg)', borderColor: 'var(--tp-danger-border)' }
