...
const secondaryButton: import('react').CSSProperties = { minWidth: 0, overflowWrap: 'anywhere', flex: '1 1 100px', color: '#e8eaf2', background: 'rgba(124,150,255,.1)', border: '1px solid rgba(145,167,255,.35)', borderRadius: 7, padding: '5px 8px', cursor: 'pointer', fontSize: 11 }
